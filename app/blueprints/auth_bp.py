...
#     if not user:
#         print("User not found:", email)  # Debug print
#         return jsonify({'message': 'Invalid email or password'}), 401

#     print("Provided Password:", password)  # Debug print
#     print("Stored Password Hash:", user.password_hash)  # Debug print

#     if not check_password_hash(user.password_hash, password):  # Compare provided password with stored hashed password
#         print("Invalid password for user:", email)  # Debug print
#         return jsonify({'message': 'Invalid email or password'}), 401

#     print("User logged in successfully:", email)  # Debug print
...
#     print("New Password Hash:", hashed_password)  # Debug print
